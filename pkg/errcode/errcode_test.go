...
func TestCode_ExitCode_taxonomy(t *testing.T) {
	cases := []struct {
		...
		{errcode.PluginUnknown, exitcode.Usage},
		{errcode.PluginNameReserved, exitcode.Usage},
		{errcode.PluginAssetNaming, exitcode.Usage},
		{errcode.PluginFetchUnauthorized, exitcode.Usage},
		{errcode.PluginFetchFailed, exitcode.Data},
		{errcode.PluginAssetMissing, exitcode.Data},
		{errcode.PluginHelpSummaryFailed, exitcode.Data},
		{errcode.PluginThirdpartyUnconfirmed, exitcode.Precondition},
